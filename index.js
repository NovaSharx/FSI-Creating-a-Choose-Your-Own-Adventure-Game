...
Do you follow it, or continue on your path?`)
        switch (secondAnswer) {
            case 'follow':
                thirdAnswer = window.prompt(`You follow the cat to a colony of cats, nestled in a fort of warm blankets and subsisting off of inexplicably warm soup. 
They are content with you staying, but you wonder if you should alert the world to this magical safe haven.`)
            ...
            break
            case 'continue':
                thirdAnswer = window.prompt(`You come across a chamber that reaches upward to a shining light above. 
...
Another path would lead you away from the dragon altogether. Which path do you take?`)
        switch (secondAnswer) {
            case 'past the dragon':
                thirdAnswer = window.prompt(`The dragon wakes up and sits upright. You only have a moment to respond, to stay or run:`)
                switch (thirdAnswer) {
                    case 'stay':
            ...
            case 'away from the dragon':
                thirdAnswer = window.prompt(`After walking a while longer, you come across a shiny blue flower. 
